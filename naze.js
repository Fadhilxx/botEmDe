...
const nyoutube = ('© Fadhilx\nhttps://fadhil.co')  //ubah di config biar ngk emror
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
	    ...
	    //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: '©Fadhilx', orderTitle: 'saru', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":false},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: '©Fadhilx',jpegThumbnail: thumb}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":'©Fadhilx', "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': '©Fadhilx', 'jpegThumbnail': thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "By Fadhilx", "caption": '©Fadhilx', 'jpegThumbnail': thumb}}}
		...
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: 'Fadhilx Dev',jpegThumbnail: thumb}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Fadhilx Dev', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Fadhilx Dev,;;;\nFN:Fadhilx Dev\nitem1.TEL;waid=62895612458445:62895612458445\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": '©Fadhilx',"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./image/fcpict.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
`.trim())
	    ...
	    case 'donate': {
            ...
            case 'sc': {
                m.reply('pengen ya?chat owner bro\nhttps://wa.me/62895612458445')
            }
            break
//PEMBATAS=======================================
...
│
│⭔ NO SPAM‼️
│⭔ Jangan maksa fitur harus bisa, masih beta🗿
│⭔ Beri jeda ketika menggunakan
│⭔ Gunakan dengan bijak‼️
│
└───────⭓`
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '💰Donate' }, type: 1 }]
...
╰──❍`
	 ...
	 let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '💰Donate' }, type: 1 }]
...
╰──❍`
	  ...
	  {title: "Webzone", rowId: `mwebzone`, description: `📹Webzone Menu *[ERROR]*`},
...
│
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '💰Donate' }, type: 1 }]
...
│⭔ ${prefix}getmusic [query] *[ERROR]*
│⭔ ${prefix}getvideo [query] *[ERROR]*
│⭔ ${prefix}umma [url] *[ERROR]*
│⭔ ${prefix}joox [query]
...
_Donasi Ngab_\n_Jangan Ngarep Free Mulu_`
	       let buttons = [{ buttonId: 'donasi', buttonText: { displayText: '💰Donate' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 }]
